...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/numberbaseconverter',
        'Source': 'https://github.com/apiverve/numberbaseconverter-api',
        'Bug Tracker': 'https://github.com/apiverve/numberbaseconverter-api/issues'
    },
    classifiers=[
