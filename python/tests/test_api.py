...
class TestNumberbaseconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = NumberbaseconverterAPIClient(self.api_key)

    @patch('apiverve_numberbaseconverter.apiClient.requests.get')
