...
{
    class NumberBaseConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/numberbaseconverter";

        /// <summary>
        /// Make a GET request to the Number Base Converter API
        /// </summary>
        static async Task<JsonDocument> CallNumberBaseConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;value&quot;] &#x3D; &quot;255&quot;, [&quot;from&quot;] &#x3D; 10, [&quot;to&quot;] &#x3D; 10 };
        ...
        {
            Console.WriteLine("📤 Calling Number Base Converter API...\n");

            var result = await CallNumberBaseConverterAPI();
