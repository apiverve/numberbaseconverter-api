# Number Base Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:numberbaseconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.numberbaseconverter.NumberBaseConverterAPIClient;
import com.apiverve.numberbaseconverter.APIResponse;
import com.apiverve.numberbaseconverter.APIException;

// Initialize the client
NumberBaseConverterAPIClient client = new NumberBaseConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("value", "FF");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/numberbaseconverter](https://docs.apiverve.com/ref/numberbaseconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/numberbaseconverter](https://docs.apiverve.com/ref/numberbaseconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/numberbaseconverter-api/issues)
