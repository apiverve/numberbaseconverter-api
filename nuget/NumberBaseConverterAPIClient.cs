...
namespace APIVerve.API.NumberBaseConverter
{
    ...
    /// <summary>
    /// Client for the NumberBaseConverter API
    /// </summary>
    public class NumberBaseConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/numberbaseconverter";
        ...
        {
            { "value", new ValidationRule { Type = "string", Required = true } },
            { "from", new ValidationRule { Type = "integer", Required = false, Min = 2, Max = 36 } },
            { "to", new ValidationRule { Type = "integer", Required = false, Min = 2, Max = 36 } }
        };
        ...
        public NumberBaseConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NumberBaseConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NumberBaseConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NumberBaseConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NumberBaseConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(NumberBaseConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NumberBaseConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NumberBaseConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NumberBaseConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NumberBaseConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NumberBaseConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NumberBaseConverterQueryOptions options)
        {
