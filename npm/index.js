...
class numberbaseconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/numberbaseconverter');
        }
        ...
        this.validationRules = {"value":{"type":"string","required":true},"from":{"type":"integer","required":false,"min":2,"max":36,"default":10},"to":{"type":"integer","required":false,"min":2,"max":36}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/numberbaseconverter`);
        }
    }
...
module.exports = numberbaseconverterWrapper;
