...
// Request contains the parameters for the Number Base Converter API.
//
// Parameters:
...
type Request struct {
	...
	From int `json:"from,omitempty"` // Optional
	To int `json:"to,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"from": {Type: "integer", Required: false, Min: float64Ptr(2), Max: float64Ptr(36)},
		"to": {Type: "integer", Required: false, Min: float64Ptr(2), Max: float64Ptr(36)},
	}
...
// ResponseData contains the data returned by the Number Base Converter API.
type ResponseData struct {
	InputValue string `json:"input_value"`
	InputBase int `json:"input_base"`
	InputBaseName string `json:"input_base_name"`
	DecimalValue int `json:"decimal_value"`
